  ...
  return (
    <div className='relative flex h-16 w-full rounded-lg p-2 bg-[#20222f] justify-between'>
      ...
      <div className='flex justify-center items-center gap-2'>
         <button className='flex justify-center items-center h-8 w-8 p-0 m-0 bg-transparent border border-gray-400 shadow-xl rounded-lg bg-slate-600 hover:bg-blue-700/25'>
          <svg
            width='20px'
            height='20px'
            viewBox='0 -0.5 25 25'
        ...
        <button className='flex justify-center items-center h-8 w-8 p-0 m-0 bg-transparent border border-red-700 shadow-xl bg-slate-600 rounded-lg hover:bg-red-700/25'>
